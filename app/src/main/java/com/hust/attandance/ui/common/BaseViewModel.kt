...
import com.hust.attandance.utils.lifecycle.DebounceLiveData
...
abstract class BaseViewModel(
    ...
    private val handlerException: LiveData<KvException> = rawException.switchMapLiveDataEmit {
        exceptionHandler.process(it)
    }

    val exception = SingleLiveEvent<KvException>().apply {
